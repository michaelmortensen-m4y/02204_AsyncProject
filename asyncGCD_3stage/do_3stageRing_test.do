# do D:/Documents/Eclipse/VHDL/AsyncTesting/asyncGCD_3stage/do_3stageRing_test.do
...
#add wave tb_3stagering/test_reset
...
# Set operand A input to something:
...
# Set operand A input to something:
force -freeze sim:/tb_3stagering/test_operandAIn 8'h3E 0
force -freeze sim:/tb_3stagering/test_operandBIn 8'h10 0
