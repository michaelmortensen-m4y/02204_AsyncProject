...
HD_PWD='/home/andreas/github/02204_AsyncProject/component_library/ctrl_delay/vivado_ctrl/vivado_ctrl.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log click_ctrl_delay.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source click_ctrl_delay.tcl -notrace
