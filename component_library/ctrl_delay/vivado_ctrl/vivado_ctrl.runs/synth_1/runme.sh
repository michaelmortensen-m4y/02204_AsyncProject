...
HD_PWD='/home/andreas/github/02204_AsyncProject/component_library/ctrl_delay/vivado_ctrl/vivado_ctrl.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log click_ctrl_delay.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source click_ctrl_delay.tcl
