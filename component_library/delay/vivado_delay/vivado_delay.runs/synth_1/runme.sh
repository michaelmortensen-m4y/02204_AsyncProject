...
HD_PWD='/home/andreas/github/02204_AsyncProject/click_components/delay/vivado_delay/vivado_delay.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log delay_stage.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source delay_stage.tcl
