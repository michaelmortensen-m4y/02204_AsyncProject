...
HD_PWD='/home/andreas/github/02204_AsyncProject/component_library/rings/1_stage_ring_no_data_FPGA/vivado_ring/vivado_project/vivado_project.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log top_ring.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source top_ring.tcl
