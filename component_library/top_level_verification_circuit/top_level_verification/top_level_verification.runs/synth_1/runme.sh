...
HD_PWD='/home/andreas/github/02204_AsyncProject/component_library/top_level_verification_circuit/top_level_verification/top_level_verification.runs/synth_1'
cd "$HD_PWD"
